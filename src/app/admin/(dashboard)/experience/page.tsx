        ...
        <div>
          <table className="text-white p-4 w-full">
            <thead className="border-t border-b border-neutral-600">
              <tr>
                <th className="p-2 sm:p-4 text-left">Company</th>
                <th className="p-2 sm:p-4 text-left">Position</th>
                <th className="p-2 sm:p-4 text-left">Location</th>
                <th className="p-2 sm:p-4 text-left">Start Date</th>
                <th className="p-2 sm:p-4 text-left">End Date</th>
            ...
            <tbody>
              {isLoading ? (
                <tr>
                  <td colSpan={7} className="pt-8 text-center text-white">
                ...
                experienceData?.map((exp) => (
                  <tr key={exp.id} className="border-b border-neutral-700">
                    <td className="p-2 sm:p-4">{exp.company}</td>
                    <td className="p-2 sm:p-4">{exp.position}</td>
                    <td className="p-2 sm:p-4">{exp.location}</td>
